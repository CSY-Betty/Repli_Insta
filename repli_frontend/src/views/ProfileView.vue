		...
		<ul class="grid grid-cols-3 gap-1">
			...
			<li class="cursor-pointer relative group">
				<img
					alt="galary2"
					class="rounded-sm object-center object-cover aspect-square"
					src="https://images.unsplash.com/photo-1526779259212-939e64788e3c?q=80&w=2974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
				/>
				<!-- image hover -->
				<div
					class="flex justify-center items-center opacity-0 bg-gradient-to-t from-gray-800 via-gray-800 to-opacity-30 group-hover:opacity-50 absolute top-0 left-0 h-full w-full"
			...
			<li class="cursor-pointer relative group">
				<img
					alt="galary3"
					class="rounded-sm object-center object-cover aspect-square"
					src="https://images.unsplash.com/photo-1626808642875-0aa545482dfb?q=80&w=2600&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
				/><!-- image hover -->
				<div
					class="flex justify-center items-center opacity-0 bg-gradient-to-t from-gray-800 via-gray-800 to-opacity-30 group-hover:opacity-50 absolute top-0 left-0 h-full w-full"
				></div>
			...
			<li class="cursor-pointer relative group">
				<img
					alt="galary4"
					class="rounded-sm object-center object-cover aspect-square"
					src="https://images.unsplash.com/photo-1617570874287-db95c419c432?q=80&w=2970&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
				/><!-- image hover -->
				<div
					class="flex justify-center items-center opacity-0 bg-gradient-to-t from-gray-800 via-gray-800 to-opacity-30 group-hover:opacity-50 absolute top-0 left-0 h-full w-full"
				></div>
			...
			<li class="cursor-pointer relative group">
				<img
					alt="galary5"
					class="rounded-sm object-center object-cover aspect-square"
					src="https://images.unsplash.com/photo-1617243876873-6cea4ea0b4eb?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
				/><!-- image hover -->
				<div
					class="flex justify-center items-center opacity-0 bg-gradient-to-t from-gray-800 via-gray-800 to-opacity-30 group-hover:opacity-50 absolute top-0 left-0 h-full w-full"
				></div>
			...
			<li class="cursor-pointer relative group">
				<img
					alt="galary6"
					class="rounded-sm object-center object-cover aspect-square"
					src="https://plus.unsplash.com/premium_photo-1661678244954-d1d766c00a57?q=80&w=2970&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
				/><!-- image hover -->
				<div
					class="flex justify-center items-center opacity-0 bg-gradient-to-t from-gray-800 via-gray-800 to-opacity-30 group-hover:opacity-50 absolute top-0 left-0 h-full w-full"
				></div>
